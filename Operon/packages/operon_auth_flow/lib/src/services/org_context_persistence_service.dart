...
class OrgContextPersistenceService {
  ...
  static const String _keyTimestamp =
      'last_selected_timestamp'; // For cache invalidation
  ...
  static Future<void> saveContext({
    ...
    await Future.wait([
      ...
      if (appAccessRoleId != null)
        prefs.setString(_keyAppAccessRoleId, appAccessRoleId),
  ...
  static Future<SavedOrgContext?> loadContext() async {
    ...
    final timestamp =
        timestampStr != null ? DateTime.fromMillisecondsSinceEpoch(int.parse(timestampStr)) : null;
