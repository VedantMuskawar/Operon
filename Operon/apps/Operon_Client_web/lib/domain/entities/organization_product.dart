...
class OrganizationProduct {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'status': status.name,
      'stock': stock,
      if (fixedQuantityPerTripOptions != null &&
          fixedQuantityPerTripOptions!.isNotEmpty)
  ...
  factory OrganizationProduct.fromJson(
    ...
    final fixedQuantityData =
        json['fixedQuantityPerTripOptions'] as List<dynamic>?;
    return OrganizationProduct(
      ...
      fixedQuantityPerTripOptions:
          fixedQuantityData?.map((e) => (e as num).toInt()).toList(),
    );
  }
