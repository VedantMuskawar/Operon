...
class _ScheduleTripModalState extends State<ScheduleTripModal> {
  ...
  void initState() {
    ...
    if (widget.clientPhones.isNotEmpty) {
      _selectedPhoneNumber = widget.clientPhones.first['e164'] as String? ??
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isLoading
                          ...
                          : const Text('Schedule', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                    ),
                  ),
                ],
              ),
        ...
        if (!_isAddingNewPhone) ...[
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 14),
              prefixIcon: const Icon(Icons.add_call, color: Colors.white54, size: 20),
