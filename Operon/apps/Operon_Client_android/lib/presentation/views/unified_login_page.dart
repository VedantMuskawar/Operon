...
import 'package:core_ui/core_ui.dart' show AuthColors, DashSnackbar, DotGridPattern, UnifiedLoginContent, parseAuthErrorMessage;
    ...
    return Scaffold(
      ...
      body: BlocConsumer<AuthBloc, AuthState>(
        ...
        buildWhen: (previous, current) {
          ...
          return previous.session?.verificationId != current.session?.verificationId ||
