...
class ScheduledOrder {
  ...
  factory ScheduledOrder.fromFirestore(
    ...
    return ScheduledOrder(
      ...
      slotLabel: (data['slotLabel'] as String?) ?? 'Trip',
      ...
      initialMeterReading: _parseNullableDouble(data['initialMeterReading']),
  ...
  Map<String, dynamic> toFirestore() {
    return {
      ...
      if (finalMeterReading != null) 'finalMeterReading': finalMeterReading,
