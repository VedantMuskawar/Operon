...
class AppTheme {
  ...
  static const Color backgroundColor = Color(0xFF0A0A0A); // Custom background
  static const Color surfaceColor = Color(0xFF161817); // Custom surface background
  static const Color cardColor = Color(0xFF161817); // Custom card background
  static const Color errorColor = Color(0xFFEF4444); // Red
  static const Color successColor = Color(0xFF10B981); // PaveBoard success green
  static const Color warningColor = Color(0xFFF59E0B); // Amber
  static const Color infoColor = Color(0xFF3B82F6); // Blue
  static const Color textPrimaryColor = Color(0xFFCBD4C7); // Custom primary text (title color)
  static const Color textSecondaryColor = Color(0xFF84838C); // Custom secondary text (subtitle color)
